...
- Current UX polish: centered `noted` end-of-meeting popup, menubar settings for model cache status / input microphone / auto-ingest, WhisperKit cache under Application Support, and visible `## Meeting Summary` sections without hidden Markdown comments.
